...
<template>
  <div
    :class="[
      customStyle,
      'flex flex-col w-9/10 font-montserrat shadow-[-5px_5px_0px_hsl(52,60%,84%)] dark:shadow-[-3px_3px_0px_hsla(52,94%,94%,30%)] p-3 md:p-5 text-description-primary dark:text-description-dark-primary ',
    ]"
  >
    ...
    <hr
      class="text-description-tertiary dark:text-description-dark-tertiary opacity-10"
    />
